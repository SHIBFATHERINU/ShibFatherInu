...
contract shibfatherInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3d291E68C43320b6fb11F36E039d3ff9774F74D8);
    ...
    string private _name = "ShibfatherInu";
    string private _symbol = "ShibfatherInu";
